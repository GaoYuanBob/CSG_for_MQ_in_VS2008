...
Vptr Mesh_CSG<VertData, TriData>::TopoCache::newVert()
{
...
template<class VertData, class TriData> inline
Eptr Mesh_CSG<VertData, TriData>::TopoCache::newEdge()
{
	Eptr e = edges.alloc(); // cache.edges
	return e;
}
template<class VertData, class TriData> inline
Tptr Mesh_CSG<VertData, TriData>::TopoCache::newTri()
{
...
template<class VertData, class TriData> inline
void Mesh_CSG<VertData, TriData>::TopoCache::freeVert(Vptr v)
{
	verts.free(v);
}

template<class VertData, class TriData> inline
void Mesh_CSG<VertData, TriData>::TopoCache::freeEdge(Eptr e)
{
	edges.free(e);
}

template<class VertData, class TriData> inline
void Mesh_CSG<VertData, TriData>::TopoCache::freeTri(Tptr t)
{
	tris.free(t);
}

template<class VertData, class TriData> inline
void Mesh_CSG<VertData, TriData>::TopoCache::deleteTri(Tptr tri)
{
...
template<class VertData, class TriData> inline
void Mesh_CSG<VertData, TriData>::TopoCache::flipTri(Tptr t)
{
...
template<class VertData, class TriData>
Mesh_CSG<VertData, TriData>::TopoCache::TopoCache(Mesh_CSG *owner) : mesh(owner)
{
	init();
}
...
template<class VertData, class TriData>
void Mesh_CSG<VertData, TriData>::TopoCache::init()
{
...
template<class VertData, class TriData>
void Mesh_CSG<VertData, TriData>::TopoCache::commit()
{
...
template<class VertData, class TriData>
bool Mesh_CSG<VertData, TriData>::TopoCache::isValid()
{
	std::set<Vptr> vaddr;
	std::set<Eptr> eaddr;
	std::set<Tptr> taddr;
...
static std::ostream& operator<<(std::ostream &out, const TopoVert& vert)
{
	out << "ref(" << vert.ref << ") "
		<< "e(" << vert.edges.size() << "):";
...
static std::ostream& operator<<(std::ostream &out, const TopoEdge& edge)
{
...
static std::ostream& operator<<(std::ostream &out, const TopoTri& tri)
{
	out << "ref(" << tri.ref << ") ";
...
template<class VertData, class TriData>
void Mesh_CSG<VertData, TriData>::TopoCache::print()
{
	using std::cout;
	using std::endl;
...
// constructors
template<class VertData, class TriData>
Mesh_CSG<VertData, TriData>::Mesh_CSG(Mesh_CSG &cp) : tris(cp.tris), verts(cp.verts) {}

template<class VertData, class TriData>
Mesh_CSG<VertData, TriData>::Mesh_CSG(const RawMesh<VertData, TriData> &raw) : tris(raw.triangles.size()), verts(raw.vertices)
{
...
template<class VertData, class TriData>
void Mesh_CSG<VertData, TriData>::operator=(Mesh_CSG &src)
{
	tris = src.tris;
	verts = src.verts;
}
...
template<class VertData, class TriData>
bool Mesh_CSG<VertData, TriData>::valid() const
{
...
template<class VertData, class TriData>
RawMesh<VertData, TriData> Mesh_CSG<VertData, TriData>::raw() const
{
...
template<class VertData, class TriData>
void Mesh_CSG<VertData, TriData>::disjointUnion(const Mesh_CSG &cp)
{
...
template<class VertData, class TriData>
typename Mesh_CSG<VertData, TriData>::Isct
Mesh_CSG<VertData, TriData>::pick(Ray3d_CSG ray)
{
	Isct result;
	result.ray = ray;
	result.exists = false;
...
template<class VertData, class TriData>
bool Mesh_CSG<VertData, TriData>::isClosed()
{
...
template<class VertData, class TriData>
typename Mesh_CSG<VertData, TriData>::NeighborCache
Mesh_CSG<VertData, TriData>::createNeighborCache()
{
...
typename Mesh_CSG<VertData, TriData>::EGraphCache<Edata>
#else
template<class VertData, class TriData>
template<class Edata>
typename Mesh_CSG<VertData, TriData>::template EGraphCache<Edata>
#endif
Mesh_CSG<VertData, TriData>::createEGraphCache()
{
...
template<class VertData, class TriData>
std::vector<uint> Mesh_CSG<VertData, TriData>::getComponentIds()
{
...
template<class VertData, class TriData>
struct Mesh_CSG<VertData, TriData>::RemeshScratchpad {
	TopoCache                               cache;
	MemPool<RemeshEdgeAuxiliary>            edge_data;
	std::set< std::pair<double, Eptr> >     queue;

	RemeshScratchpad(Mesh_CSG<VertData, TriData> *mesh) : cache(mesh) {}
};


template<class VertData, class TriData>
void Mesh_CSG<VertData, TriData>::remesh()
{
...
template<class VertData, class TriData>
void Mesh_CSG<VertData, TriData>::scoreAndEnqueue(std::set< std::pair<double, Eptr> > &queue, Eptr edge)
{
...
template<class VertData, class TriData>
void Mesh_CSG<VertData, TriData>::dequeue(std::set< std::pair<double, Eptr> > &queue, Eptr edge)
{
...
template<class VertData, class TriData>
double Mesh_CSG<VertData, TriData>::computeEdgeScore(Eptr edge) {
	double edge_length;
...
template<class VertData, class TriData> inline
void Mesh_CSG<VertData, TriData>::populateTriFromTopoTri(Tptr tri) {
...
template<class VertData, class TriData>
Eptr Mesh_CSG<VertData, TriData>::allocateRemeshEdge(
...
template<class VertData, class TriData>
void Mesh_CSG<VertData, TriData>::deallocateRemeshEdge(RemeshScratchpad &scratchpad, Eptr e)
{
...
template<class VertData, class TriData>
void Mesh_CSG<VertData, TriData>::edgeCollapse(RemeshScratchpad &scratchpad, Eptr e_collapse, bool collapsing_tetrahedra_disappear)
{
	/*
	*
...
template<class VertData, class TriData>
void Mesh_CSG<VertData, TriData>::edgeSplit(RemeshScratchpad &scratchpad, Eptr e_split)
{
	/*
...
template<class VertData, class TriData>
class Mesh_CSG<VertData, TriData>::TriangleProblem
{
public:
	TriangleProblem() {}
	~TriangleProblem() {}
...
template<class VertData, class TriData>
class Mesh_CSG<VertData, TriData>::IsctProblem : public TopoCache
{
public:
	IsctProblem(Mesh_CSG *owner) : TopoCache(owner)
	{
...
template<class VertData, class TriData>
bool Mesh_CSG<VertData, TriData>::IsctProblem::tryToFindIntersections()
{
	...
	//							if (t0 < t1 && t0 < t2)
	//							{
	//								Mesh_CSG<VertData, TriData>::Tprob prob1 = reinterpret_cast<Mesh_CSG<VertData, TriData>::Tprob>(t1->data);
	...
	// GY 如果卡住了，尝试这个输出，看是不是很大，正常只有20左右，或者是0
	//printf(" ********  triples.size() = %d ******* \n", triples.size());
...
template<class VertData, class TriData>
void Mesh_CSG<VertData, TriData>::IsctProblem::perturbPositions()
{
...
template<class VertData, class TriData>
void Mesh_CSG<VertData, TriData>::IsctProblem::reset()
{
...
template<class VertData, class TriData>
void Mesh_CSG<VertData, TriData>::IsctProblem::findIntersections()
{
	int nTrys = 5;
...
template<class VertData, class TriData>
bool Mesh_CSG<VertData, TriData>::IsctProblem::hasIntersections()
{
...
template<class VertData, class TriData>
bool Mesh_CSG<VertData, TriData>::IsctProblem::checkIsct(Eptr e, Tptr t) const
{
...
template<class VertData, class TriData>
bool Mesh_CSG<VertData, TriData>::IsctProblem::checkIsct(Tptr t0, Tptr t1, Tptr t2) const
{
...
template<class VertData, class TriData>
Vec3d Mesh_CSG<VertData, TriData>::IsctProblem::computeCoords(Eptr e, Tptr t) const
{
	Empty3d::TriEdgeIn input;
	marshallArithmeticInput(input, e, t);
...
template<class VertData, class TriData>
Vec3d Mesh_CSG<VertData, TriData>::IsctProblem::computeCoords(Tptr t0, Tptr t1, Tptr t2) const
{
	Empty3d::TriTriTriIn input;
	marshallArithmeticInput(input, t0, t1, t2);
	Vec3d coords = Empty3d::coordsExact(input);
...
template<class VertData, class TriData>
void Mesh_CSG<VertData, TriData>::IsctProblem::fillOutVertData(GluePt glue, VertData &data)
{
...
template<class VertData, class TriData>
void Mesh_CSG<VertData, TriData>::IsctProblem::fillOutTriData(Tptr piece, Tptr parent)
{
	TopoCache::mesh->subdivide_tri(piece->ref, parent->ref);
}

template<class VertData, class TriData>
class Mesh_CSG<VertData, TriData>::IsctProblem::EdgeCache
{
public:
...
template<class VertData, class TriData>
void Mesh_CSG<VertData, TriData>::IsctProblem::createRealPtFromGluePt(GluePt glue) {
...
template<class VertData, class TriData>
void Mesh_CSG<VertData, TriData>::IsctProblem::createRealTriangles(Tprob tprob, EdgeCache &ecache)
{
...
template<class VertData, class TriData>
void Mesh_CSG<VertData, TriData>::IsctProblem::resolveAllIntersections()
{
...
template<class VertData, class TriData>
void Mesh_CSG<VertData, TriData>::IsctProblem::dumpIsctPoints(std::vector<Vec3d> *points)
{
...
template<class VertData, class TriData>
void Mesh_CSG<VertData, TriData>::IsctProblem::dumpIsctEdges(std::vector< std::pair<Vec3d, Vec3d> > *edges)
{
	edges->clear();
...
template<class VertData, class TriData>
void Mesh_CSG<VertData, TriData>::testingComputeStaticIsctPoints(std::vector<Vec3d> *points)
{
...
template<class VertData, class TriData>
void Mesh_CSG<VertData, TriData>::testingComputeStaticIsct(std::vector<Vec3d> *points, std::vector< std::pair<Vec3d, Vec3d> > *edges)
{
	IsctProblem iproblem(this);
...
template<class VertData, class TriData>
void Mesh_CSG<VertData, TriData>::resolveIntersections()
{
	IsctProblem iproblem(this);
...
template<class VertData, class TriData>
bool Mesh_CSG<VertData, TriData>::isSelfIntersecting()
{
	IsctProblem iproblem(this);
...
template<class VertData, class TriData>
class Mesh_CSG<VertData, TriData>::BoolProblem
{
public:
	BoolProblem(Mesh_CSG *owner) : mesh(owner) {}
	virtual ~BoolProblem() {}

	// do things
	void doSetup(Mesh_CSG &rhs);
...
template<class VertData, class TriData>
void Mesh_CSG<VertData, TriData>::BoolProblem::doSetup(Mesh_CSG &rhs)
{
	// Label surfaces...
	mesh->mesh_for_tris();
...
template<class VertData, class TriData>
void Mesh_CSG<VertData, TriData>::boolUnion(Mesh_CSG &rhs)
{
...
template<class VertData, class TriData>
void Mesh_CSG<VertData, TriData>::boolDiff(Mesh_CSG &rhs)
{
	BoolProblem bprob(this);
	bprob.doSetup(rhs);
...
template<class VertData, class TriData>
void Mesh_CSG<VertData, TriData>::boolIsct(Mesh_CSG &rhs)
{
	BoolProblem bprob(this);
	bprob.doSetup(rhs);
...
template<class VertData, class TriData>
void Mesh_CSG<VertData, TriData>::boolXor(Mesh_CSG &rhs)
{
	BoolProblem bprob(this);
	bprob.doSetup(rhs);
